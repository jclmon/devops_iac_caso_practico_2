...
output "aks_kubeconfig_command" {
	description = "Command to get kubeconfig for the AKS cluster (for manual retrieval)."
	value       = "az aks get-credentials --resource-group ${azurerm_resource_group.rg.name} --name ${azurerm_kubernetes_cluster.aks.name}"
}

output "aks_kubeconfig_path" {
	description = "Path to the kubeconfig file generated by Terraform."
	value       = local_file.kubeconfig.filename
}

output "kubeconfig_generated" {
	description = "Confirmation that kubeconfig was automatically generated."
	value       = "✓ kubeconfig written to: ${local_file.kubeconfig.filename}"
}
